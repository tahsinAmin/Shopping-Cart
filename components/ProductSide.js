...
function ProductSide({ items,onAdd }) {
   return (
      <div className='w-8/12 border p-2 flex flex-col justify-between'>
         <div className="flex-col space-y-3">
            <input className='w-full h-16 border-radius-10 px-3 rounded-md outline:none placeholder-shown:text-lg placeholder-shown:text-black' type="text" placeholder='Search products ...' />
         ...
         <div className="location border-t-2 border-gray-200 flex justify-between pt-2">
